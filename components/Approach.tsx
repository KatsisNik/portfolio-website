...
const AceternityIcon = ({order}:{order:string}) => {
  return (
    <div>
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-blue-50 rounded-lg" />
      <div className="px-8 py-2  bg-black-100 rounded-[6px]  relative group transition duration-200 text-white hover:bg-transparent text-2xl font-bold">
        {order}
      </div>
    </button>
    </div>
