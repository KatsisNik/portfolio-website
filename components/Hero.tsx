...
import UnapologeticButton from './ui/unapologetic-button'
  ...
  return (
    <div className='pb-20 pt-36'>
        <div>
            ...
            <Spotlight className="top-10 left-full h-[80vh] w-[50vw]" fill='blue-0' />
            <Spotlight className="top-28 left-80 h-[80vh] w-[50vw]" fill="blue" />
        </div>
        
        <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-blue-0/[0.05] bg-grid-black/[0.1] flex items-center justify-center absolute top-0 left-0">
        ...
        <div className="flex justify-center relative my-20 z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vs] flex flex-col items-center justify-center">
                ...
                <TextGenerateEffect 
                    ...
                    words="Full-Stack Web-App Development"
                />
